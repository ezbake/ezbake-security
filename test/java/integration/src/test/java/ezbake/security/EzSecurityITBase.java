...
public class EzSecurityITBase {
    ...
    public static void setUpServerPool() throws Exception {
        ...
        int REDIS_PORT = portChooser.nextInt((23958 - 22456) + 1) + 22456;
        ...
        properties.setProperty(EzBakePropertyConstants.REDIS_PORT, Integer.toString(REDIS_PORT));
        ...
        client.setSecurityIdForCommonService(App, "10000000");
