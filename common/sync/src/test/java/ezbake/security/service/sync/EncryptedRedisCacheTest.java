...
public class EncryptedRedisCacheTest {
    ...
    public void setUp() throws Exception {
        ...
        p.setProperty(EzBakePropertyConstants.REDIS_HOST, InetAddress.getLocalHost().getCanonicalHostName());
        p.setProperty(EzBakePropertyConstants.REDIS_PORT, Integer.toString(REDIS_PORT));
