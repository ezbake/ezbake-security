...
public class EzPersistUtil {
    ...
    public static AppCerts getAppCerts(AppPersistenceModel app, AppPersistenceModel caApm, AppPersistenceModel securityApm) throws RegistrationException {
        log.info("Fetching the CA certificate");
