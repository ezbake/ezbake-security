...
public class ClientLookup implements EzbakeRegistrationService {
    ...
    private static final String CLIENT_TABLE_DEFAULT = "Registrations";

    private LoadingCache<String, AppInstance> appCache;

    @Inject
    public ClientLookup(Properties properties) throws AccumuloSecurityException, AccumuloException {
        appCache = CacheBuilder.newBuilder()
                .concurrencyLevel(20)
                .refreshAfterWrite(2, TimeUnit.MINUTES)
                .expireAfterWrite(10, TimeUnit.MINUTES)
                .build(new RegistrationLoader(properties));
    }
    ...
    protected static class RegistrationLoader extends CacheLoader<String, AppInstance> {
        ...
        public RegistrationLoader(Properties properties) throws AccumuloSecurityException, AccumuloException {
            manager = new AccumuloRegistrationManager(properties, "ezbake_"+CLIENT_TABLE_DEFAULT);
